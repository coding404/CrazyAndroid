package com.liushu.crazyandroid.ui.stage01.chapter04.fragment;
...
public class Chapter04Fragment extends Fragment {
    private ExpandableListView mElv_chapter04;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape04, null);
        mElv_chapter04 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter04);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mElv_chapter04.setAdapter(mViewAdapter);
        mElv_chapter04.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            @Override
    ...
    private void initData() {
        mBeen = new ArrayList<>();
        String s = FileUtil.readFromAssets(getContext(), "chapter04.txt");
        Gson gson=new Gson();
