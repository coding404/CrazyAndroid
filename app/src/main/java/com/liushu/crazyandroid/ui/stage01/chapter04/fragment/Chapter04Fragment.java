...
public class Chapter04Fragment extends BaseFragment {
    @BindView(R.id.expendlist_chapter04)
    ExpandableListView mElv_chapter04;
    private MyExpandableListViewAdapter mViewAdapter;
    private List<CatalogBean.ChaptersBean> mBeen;

    @Override
    protected int getLayoutResource() {
        return R.layout.fragment_chape04;
    }
    ...
    private void initData() {
        mBeen = new ArrayList<>();
        String s = FileUtil.readFromAssets(getContext(), "chapter04.json");
        Gson gson = new Gson();
