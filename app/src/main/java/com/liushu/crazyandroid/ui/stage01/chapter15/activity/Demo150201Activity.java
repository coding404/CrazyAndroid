package com.liushu.crazyandroid.ui.stage01.chapter15.activity;
...
import com.liushu.crazyandroid.widget.BubbleView;

;

public class Demo150201Activity extends AppCompatActivity implements SensorEventListener {
    // 定义水平仪的仪表盘
    BubbleView show;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo150201);
        // 获取水平仪的主组件
        show = (BubbleView) findViewById(R.id.bv_test);
        // 获取传感器管理服务
