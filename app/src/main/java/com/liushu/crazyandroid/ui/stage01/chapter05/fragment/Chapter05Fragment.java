...
public class Chapter05Fragment extends Fragment {
    private ExpandableListView mElv_chapter05;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape05, null);
        mElv_chapter05 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter05);
        return view;
    }
