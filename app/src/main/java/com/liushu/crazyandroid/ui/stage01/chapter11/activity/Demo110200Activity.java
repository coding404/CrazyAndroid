...
public class Demo110200Activity extends BaseActivity {
    ...
    private final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Demo110200Activity.this.cameraDevice = cameraDevice;
            // 开始预览
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            cameraDevice.close();
            Demo110200Activity.this.cameraDevice = null;
        }
        ...
        public void onError(CameraDevice cameraDevice, int error) {
            cameraDevice.close();
            Demo110200Activity.this.cameraDevice = null;
            Demo110200Activity.this.finish();
        }
    };
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface
                    , imageReader.getSurface()), new CameraCaptureSession.StateCallback() // ③
                    {
                        ...
                        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                            Toast.makeText(Demo110200Activity.this, "配置失败！"
                    ...
                    new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader reader) {
                            ...
                            try (
                                ...
                                output.write(bytes);
                                Toast.makeText(Demo110200Activity.this, "保存: "
