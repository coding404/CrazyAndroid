...
public class Chapter16Fragment extends Fragment{
    private ExpandableListView mElv_chapter16;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape16, null);
        mElv_chapter16 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter16);
        return view;
    }
    ...
    private void initData() {
        mBeen = new ArrayList<>();
        String s = FileUtil.readFromAssets(getContext(), "chapter16.txt");
        Gson gson=new Gson();
