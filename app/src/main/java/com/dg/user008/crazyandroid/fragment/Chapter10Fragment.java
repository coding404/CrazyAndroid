...
public class Chapter10Fragment extends Fragment {
    private ExpandableListView mElv_chapter10;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape10, null);
        mElv_chapter10 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter10);
        return view;
    }
