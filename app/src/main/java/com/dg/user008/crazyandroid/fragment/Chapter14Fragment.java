...
public class Chapter14Fragment extends Fragment {
    private ExpandableListView mElv_chapter14;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape14, null);
        mElv_chapter14 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter14);
        return view;
    }
    ...
    private void initData() {
        mBeen = new ArrayList<>();
        String s = FileUtil.readFromAssets(getContext(), "chapter14.txt");
        Gson gson=new Gson();
