...
public class Chapter06Fragment extends Fragment {
    private ExpandableListView mElv_chapter06;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_chape06, null);
        mElv_chapter06 = (ExpandableListView) view.findViewById(R.id.expendlist_chapter06);
        return view;
    }
    ...
    private void initData() {
        mBeen = new ArrayList<>();
        String s = FileUtil.readFromAssets(getContext(), "chapter06.txt");
        Gson gson=new Gson();
