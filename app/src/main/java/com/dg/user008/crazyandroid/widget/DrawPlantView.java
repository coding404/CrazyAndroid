...
/**
 * Created by liushu on 2017/4/18.
 */

public class DrawPlantView extends View {
    ...
    public DrawPlantView(Context context) {
        this(context,null);
    }

    public DrawPlantView(Context context, AttributeSet attrs) {
        super(context, attrs);
